    ...
    <div class="container">
        <div class="row">
                    ...
                    @foreach ($user->store as $item)
                            <div class="col-3">
                                <div class="text-center">
                                    <a class="" href="{{route('store.profile',$item->id)}}"><img class="img img-fluid text-center rounded-circle" src="{{'/images/'.$item->store_image}}" alt=""></a>
                                </div>
            ...
            <div class="col-12 border-bottom">
                    <h2 class="mt-2">เพิ่มร้านค้าของคุณ</h2>
